...
int Message::TextReply(int Type, std::string Token, std::string Text) {
    ...
    Header.append("&reply_to_message_id=");
    Header.append(std::to_string(this->Data.MessageID));
    Header.append("&allow_sending_without_reply=true");
